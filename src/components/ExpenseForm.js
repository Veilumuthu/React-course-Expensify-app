...
const now = moment();
export default class ExxpenseForm extends React.Component {
    constructor(props){
        super(props);
        this.state = {
            ...
            <div>
                ...
                <form onSubmit={this.onSubmit}>
                    ...
                    <input type="number" placeholder="Amount" 
                        value={this.state.amount} onChange={this.onAmountChange}/><br></br>
                    <SingleDatePicker date={this.state.createdAt} 
                            onDateChange={this.onDateChange} focused={this.state.calenderFocused}
